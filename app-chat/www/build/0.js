...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ng_socket_io__ = __webpack_require__(217);
...
var HomePage = /** @class */ (function () {
    function HomePage(socket, toastCtrl, alertCtrl, formBuilder) {
        this.socket = socket;
    ...
    HomePage.prototype.init = function () {
        ...
        this.messageForm = this.formBuilder.group({
            message: new __WEBPACK_IMPORTED_MODULE_4__angular_forms__["b" /* FormControl */]('')
        });
        this.chatBox = '';
        this.presentPrompt().then(function (nickname) {
            _this.nickname = nickname;
            _this.socket.connect();
            _this.socket.emit('set-nickname', _this.nickname);
            _this.getMessages().subscribe(function (message) {
                _this.messages.push(message);
                _this.scrollToBottom();
            });
            _this.getUsers().subscribe(function (data) {
                var user = data['user'];
                if (data['event'] === 'left') {
...
var socket_io_service_1 = __webpack_require__(162);
/** Socket factory */
...
var io = __webpack_require__(267);
var socket_io_module_1 = __webpack_require__(161);
...
var yeast = __webpack_require__(169);
...
var Observable_1 = __webpack_require__(8);
var share_1 = __webpack_require__(117);
...
var parser = __webpack_require__(84);
var Manager = __webpack_require__(165);
...
exports.Manager = __webpack_require__(165);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(284)(module), __webpack_require__(11)))
...
if (typeof window === 'undefined') {
  try {
    NodeWebSocket = __webpack_require__(289);
  } catch (e) { }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ng_socket_io__ = __webpack_require__(217);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_config__ = __webpack_require__(319);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    HomePageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_3_ng_socket_io__["SocketIoModule"].forRoot(__WEBPACK_IMPORTED_MODULE_4__app_config__["a" /* configSocketIO */])
            ],
        })
    ], HomePageModule);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return configSocketIO; });
var configSocketIO = {
...
var hasBinary = __webpack_require__(168);
...
if (global && global.ArrayBuffer) {
  base64encoder = __webpack_require__(285);
}
...
var Blob = __webpack_require__(286);
